...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2019 at 05:55 AM
...
--
CREATE DATABASE IF NOT EXISTS `electronics_vendor` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
--
ALTER TABLE `order`
  ADD CONSTRAINT `order_ibfk_1` FOREIGN KEY (`customer`) REFERENCES `online_customer` (`customer_id`),
