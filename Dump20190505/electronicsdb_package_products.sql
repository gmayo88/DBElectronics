...
CREATE TABLE `package_products` (
  ...
  KEY `product` (`product`),
  CONSTRAINT `package_products_ibfk_1` FOREIGN KEY (`package`) REFERENCES `package` (`package_id`),
  CONSTRAINT `package_products_ibfk_2` FOREIGN KEY (`product`) REFERENCES `product` (`product_id`)
